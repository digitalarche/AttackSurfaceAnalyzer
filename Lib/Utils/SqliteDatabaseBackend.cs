...
{
    public class SqliteDatabaseBackend : DatabaseBackend
    {
        ...
        public override bool Setup(string filename = null)
        {
            if (filename != null)
            {
        ...
        public override bool IsFlushing()
        {
            return HasElements();
        }
        ...
        public override List<RawCollectResult> GetResultsByRunid(string runid)
        {
        ...
        public override void VerifySchemaVersion()
        {
        ...
        public override List<string> GetLatestRunIds(int numberOfIds, string type)
        {
        ...
        public override Dictionary<RESULT_TYPE, bool> GetResultTypes(string runId)
        {
        ...
        public override void Write(CollectObject objIn, string runId)
        {
        ...
        public override List<RawCollectResult> GetMissingFromFirst(string firstRunId, string secondRunId)
        {
            var output = new List<RawCollectResult>();
        ...
        public override List<RawModifiedResult> GetModified(string firstRunId, string secondRunId)
        {
